...
export async function loader({ request }: DataFunctionArgs) {
	...
	if (dbUser.subscription?.subscriptionId) {
		...
		// Sets session flash value to `true` with the intent to re-fetching subscription.
	...
	if (!dbUser.subscription?.subscriptionId) {
		// Sets session flash value to `false` with the intent to re-fetch subscription.
